...
const form = ref({
  ...
  conto: 'Contanti',     // Default
  categoria: 'Spesa',    // Default
            ...
            <div class="row g-3 mb-3">
              <div class="col-6">
                ...
                <select v-model="form.conto" class="form-select">
                   <option>Contanti</option><option>Intesa</option><option>Revolut</option>
                </select>
              </div>
              <div class="col-6">
                <label class="small fw-bold text-muted mb-1">Categoria</label>
                <select v-model="form.categoria" class="form-select">
                   <option>Spesa</option><option>Casa</option><option>Auto</option><option>Svago</option>
                </select>
              </div>
            </div>
